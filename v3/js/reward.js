(function() {
  ...
  const dom = window.AppDom;
    ...
    function selectRewardPokemon(pokemonList, ownedIds, rewardCount, level) {
      ...
      return window.AppQuiz.shuffleArray(candidates).slice(0, rewardCount);
    }
    ...
    async function showResult() {
      ...
      dom.resultScore.textContent = constants.QUIZ_QUESTION_COUNT + "もん中 " + state.correctCount + "もん せいかい！";
