...
import { USER_OPTIONS } from "./constants.js";
...
export function validatePokemonList(pokemonList) {
...
export function prefetchCurrentGenerationMaster(userData) {
...
export async function getCurrentGenerationMaster(userData) {
...
export async function getGenerationMaster(generation) {
...
export async function loadUserData(userId) {
  ...
  state.selectedUserLabel = USER_OPTIONS[userId].label;
  ...
  resetCachedMaster();
  setLoadingMessage("データを よみこんでいます。", state.selectedUserLabel + " のデータを よみこみ中");
...
export async function savePendingRewardOnce() {
...
export async function savePendingRewardWithRetry() {
  try {
